  ...
  return (
    <Fragment>
      ...
      >
        {/* Modal panel */}
        <div
          className={`relative mx-3 my-4 flex max-h-[calc(100vh-2rem)] w-full flex-col ${sizeClasses[size]} rounded-lg border border-gray-700 bg-white shadow-xl transition-all dark:bg-gray-900`}
